...
public class RemoteFetchServiceRequestTests extends AbstractWireSerializingTestCase<RemoteFetchService.Request> {
    ...
    protected RemoteFetchService.Request mutateInstance(RemoteFetchService.Request instance) throws IOException {
        return switch (between(0, 2)) {
            case 0 -> new RemoteFetchService.Request(randomAlphaOfLengthBetween(5, 12), instance.fields(), instance.handles());
            case 1 -> new RemoteFetchService.Request(instance.sessionId(), randomList(1, 5, this::randomField), instance.handles());
            default -> new RemoteFetchService.Request(instance.sessionId(), instance.fields(), randomList(0, 8, this::randomHandle));
        };
    }
