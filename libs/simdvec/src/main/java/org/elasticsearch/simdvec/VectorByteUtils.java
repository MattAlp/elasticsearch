 ...
 * }</pre>
 */
public interface VectorByteUtils {
     ...
     * <pre>{@code
     * long mask = VectorByteUtils.equalMask(data, offset, target);
     *
     ...
     * an array.length, and laneCount is {@link #vectorLength()}. This is analogous to
